...
<head>
	...
	<meta name="viewport" content="width=device-width, initial-scale=1"/>
		...
		<?php // wordpress head functions — Font Awesome & ScrollReveal enqueued in library/starter.php ?>
		<?php wp_head(); ?>
	...
	<body <?php body_class(); ?> itemscope itemtype="http://schema.org/WebPage">
		...
		<div id="container">
			...
			<?php
			$hero_cfg = function_exists( 'client_get_hero_config' ) ? client_get_hero_config() : array();
					...
					<nav role="navigation" class="header-nav" itemscope itemtype="http://schema.org/SiteNavigationElement">
						<div class="header-nav__wrapper">
							<?php wp_nav_menu(array(
								...
								'menu' => __( 'The Main Menu', 'client_theme' ),
							...
							<?php wp_nav_menu(array(
								...
								'menu' => __( 'Login and Forms', 'client_theme' ),
								'menu_class' => 'nav top-nav ',
