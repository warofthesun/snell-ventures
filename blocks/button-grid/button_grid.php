 ...
 * Repeater of link buttons; width and buttons-per-row options.
 */

$block_id = ! empty( $block['anchor'] ) ? $block['anchor'] : 'button-grid-' . $block['id'];

if ( function_exists( 'client_block_inserter_preview' ) && client_block_inserter_preview( $block, 'button-grid' ) ) {
	return;
}
...
<div id="<?php echo esc_attr( $block_id ); ?>"
	...
	style="--button-grid-max-w: <?php echo (int) $max_w; ?>px;">
