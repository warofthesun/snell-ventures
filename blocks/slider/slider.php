...
if ( is_array( $gallery ) && ! empty( $gallery ) ) {
	foreach ( $gallery as $img ) {
		...
		if ( $id ) {
			...
			$size    = ( $slider_type === 'slideshow' ) ? 'client_slider_square' : 'large';
...
if ( empty( $items ) ) {
	echo '<div class="c-slider c-slider--empty' . esc_attr( $align ) . '"><p class="c-slider__empty">' . esc_html__( 'Add images to the gallery. Each image title will become a clickable list item.', 'client_theme' ) . '</p></div>';
	return;
}

if ( $slider_type !== 'table_of_contents' && $slider_type !== 'horizontal' && $slider_type !== 'slideshow' ) {
	echo '<div class="c-slider c-slider--empty' . esc_attr( $align ) . '"><p class="c-slider__empty">' . esc_html__( 'This slider style is not yet available.', 'client_theme' ) . '</p></div>';
	return;
}
...
<div class="c-slider c-slider--<?php echo esc_attr( $slider_type ); ?><?php echo esc_attr( $align ); ?>"
	 ...
	 role="region"
	 aria-label="<?php esc_attr_e( 'Image slider', 'client_theme' ); ?>">
	...
	<div class="c-slider__content">
		<div class="c-slider__col-left">
			...
			<nav class="c-slider__list" aria-label="<?php esc_attr_e( 'Choose item', 'client_theme' ); ?>">
