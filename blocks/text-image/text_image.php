<?php 
    ...
    $is_inside_container = ! empty( $block['context']['client/insideContainer'] );
    $enable_bg         = $is_inside_container ? false : get_field('use_colored_background');
    $content_full_width = (bool) get_field('content_full_width');
    $bg_choice        = get_field('background_color') ?: 'surface_muted';
    $bg_map = [
        'surface_muted'  => 'var(--c-surface-muted)',
        'surface_subtle' => 'var(--c-surface-subtle)',
        'text_muted'     => 'var(--c-text-muted)',
        'white'          => 'var(--c-white)',
        /* Legacy ACF values (existing content) */
        'sage'           => 'var(--c-surface-muted)',
        'cream'          => 'var(--c-surface-subtle)',
        'charcoal'       => 'var(--c-text-muted)',
    ];
    $bg_value = $bg_map[ $bg_choice ] ?? $bg_map['surface_muted'];
...
<div class="<?php echo esc_attr(implode(' ', array_filter($classes_band))); ?>"<?php echo $style_attr; ?>>
    ...
    <div class="c-waveband__bg" style="--waveband-max-h: 800px;"></div>
