# Client theme (starter)

Personal WordPress starter: ACF blocks, The Events Calendar integration, BEM-style SCSS. **Workflow:** [STARTER.md](STARTER.md). **What lives in `functions.php`:** [FUNCTIONS-MAP.md](FUNCTIONS-MAP.md).
