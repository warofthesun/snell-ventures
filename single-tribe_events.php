 ...
 */
add_filter( 'the_content', 'client_single_event_remove_title_and_thumbnail', 1 );
 ...
 * @return string
 */
function client_single_event_remove_title_and_thumbnail( $content ) {
	if ( ! is_singular( 'tribe_events' ) ) {
		return $content;
	}
	remove_filter( 'the_content', 'client_single_event_remove_title_and_thumbnail', 1 );
...
get_header();
if ( client_get_hero_config()['show'] ) {
					...
					<main id="main" class="col-xs-12" role="main" itemscope itemprop="mainContentOfPage" itemtype="http://schema.org/Blog">
						...
						<?php else : ?>
							<article id="post-not-found" class="hentry">
								...
								<footer class="article__footer">
									<p><?php _e( 'This is the error message for the single event template.', 'client_theme' ); ?></p>
								</footer>
							</article>
						<?php endif; ?>
					</main>
