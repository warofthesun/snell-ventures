...
- **Post Settings** (submenu under Site Settings) fields live in `group_client_post_settings.json` and use `options_page == post-settings`.

New blog/events options added in code belong in **`group_client_post_settings.json`**, not in the main Site Settings group.
